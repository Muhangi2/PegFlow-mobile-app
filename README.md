...
Payvia is a lightweight application that makes USDC useful in everyday life.  
...
The goal is to bridge USDC with real-world use cases while keeping the experience simple and accessible.
